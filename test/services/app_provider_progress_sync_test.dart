...
void main() {
  ...
  test(
    'markChallengeComplete syncs updated progress after local completion',
    () async {
      ...
      expect(
        repository.savedSnapshot!.user.completedChallengeIds,
  ...
  test(
    'init restores remote progress before provider loads challenges',
    () async {
      ...
      expect(
        provider
            ...
            .any((challenge) => challenge.id == 'uc-remote'),
        isTrue,
      );
    },
  );
