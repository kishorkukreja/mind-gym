  ...
  static final List<Challenge> allChallenges = [
    ...
    Challenge(
      ...
      hintTiers: [
        ...
        "Consider: \"The box is already set - my choice can't change what's in it.\" This seems right. But 99.9% of one-boxers are millionaires. If you two-box, you're almost certainly in the group that has only GBP 1,000. Does this matter?",
